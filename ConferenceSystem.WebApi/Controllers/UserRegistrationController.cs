using ConferenceSystem.WebApi.Results;
...
namespace ConferenceSystem.WebApi.Controllers
{
    ...
    public class UserRegistrationController : ApiController
    {
        ...
        public async Task<IHttpActionResult> ObtainLocalAccessToken(string provider, string externalAccessToken)
        {
            ...
            IdentityUser user = await _applicationUser.FindAsync(new UserLoginInfo(provider, verifiedAccessToken.user_id));
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            IdentityUser user = await _applicationUser.FindAsync(new UserLoginInfo(externalLogin.LoginProvider, externalLogin.ProviderKey));
        ...
        private string ValidateClientAndRedirectUri(HttpRequestMessage request, ref string redirectUriOutput)
        {
            ...
            var client = _applicationUser.FindByName(clientId);
        ...
        #region External authentication private methods
